...
<section id="faq" class="py-20 bg-white dark:bg-gray-900">
	<div class="max-w-6xl mx-auto px-8">
		...
		<div class="mb-16 text-center">
			<div class="text-caption mb-4 text-gray-600 dark:text-gray-400">{sectionNumber} — {faqData.header?.replace(/^\d+\s*—\s*/, '') || 'PREGUNTAS FRECUENTES'}</div>
						...
						<div class="px-6 pb-5 pt-2 bg-white dark:bg-gray-700">
							...
							{#if item.hasContactButton}
								...
								>
									...
									{faqData.contactWhatsApp || 'Contactar por WhatsApp'}
								</a>
							{/if}
						</div>
					</div>
